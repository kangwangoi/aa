...
const appendDataElement = (data) => {
    const container = document.getElementById("gameContainer");
        ...
        gameCard.className = `col-md-2 game-card game-card-${game.id}`;
        console.log("thumbnail: ", game.thumbnail, " - title: ", game.title);
        gameCard.innerHTML = `
            <div class="card">
                <img src=${game.thumbnail} style="width: 248px; padding: 10px 10px 0 10px;"/>
                <div class="card-body" style="width:248px">
                    <h5>${game.title || 'N/A'}</h5>
                    <p>free</p>
                </div>
            </div>
        `;
